              ...
              <c:forEach items="${orders }" var="order">
                ...
                <div class="ordered-wrapper ">
                  <div class="row orderd">
                    ...
                    <span class="order-date">date: ${order.date }</span> <span class="order-total-price">price :
                      ...
                      <div class="ordered-item col">
                        <div class="ordered-item-detail row">
                          <div class="main-item-img">
                            <img src="./assets/images/product/${item.product.img }/${item.product.img }_1.jpg" alt="">
                          </div>
                          <a href="productDetails?idProduct=${item.product.idProduct }" class="main-item-text">
                            <span>${item.product.brand }
                          ...
                          <div class="overlay-review hide-modal row">
                            <form action="reviewProcess" class="form-review " method="post">
                              ...
                              <div class="row form-review-rating">
                                <input type="number" name="orderId" value="${order.id  }" hidden> <input type="number"
                                  name="idProduct" value="${item.product.idProduct }" hidden> <input type="number"
                                  name="rvper" value="0" hidden> <input type="number" name="rating" hidden> <i
                                  class="ti-star review-rating" value="1"></i> <i class="ti-star review-rating"
                                  value="2"></i> <i class="ti-star review-rating" value="3"></i> <i
                                  class="ti-star review-rating" value="4"></i> <i class="ti-star review-rating"
                                  value="5"></i>
