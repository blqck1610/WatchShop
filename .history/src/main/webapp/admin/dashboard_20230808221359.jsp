  ...
  <body>
    ...
    <aside class="sidebar-nav-wrapper">
      <div class="navbar-logo">
        <a href="dashboard">
          <img src="../assets/images/logo/logostore.png" width="180" alt="logo" />
        </a>
      </div>
        ...
        <ul>
          <li class="nav-item nav-item-has-children">
            ...
            <ul id="ddmenu_1" class="collapse show dropdown-nav">
              <li>
                <a href="dashboard" class="active"> WatchStore </a>
              </li>
              <li>
                <a href="orderlist" class="active"> Order list </a>
              </li>
            </ul>
          </li>
          <li class="nav-item nav-item-has-children">
                  ...
                  <button class="dropdown-toggle bg-transparent border-0" type="button" id="profile"
                    ...
                    <div class="profile-info">
                      <div class="info">
                        ...
                        <div>
                          <h6 class="fw-500">${admin.username}</h6>
                          <p>Admin</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile">
                    <li>
                      <div class="author-info flex items-center !p-1">
                        <div class="image">
                          <img src="../assets/images/logo/avatar_default.jpg" alt="image">
                        </div>
                        <div class="content">
                          <h4 class="text-sm">nguyen</h4>
                          <a class="text-black/40 dark:text-white/40 hover:text-black dark:hover:text-white text-xs"
                            href="#">tdnguyen161****@gmail.com</a>
                        </div>
                      </div>
                    </li>
                    <li class="divider"></li>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img
                                src="../assets/images/product/Air-King_Automatic_Black/Air-King_Automatic_Black_1.jpg"
                                alt="" />
                            </div>
                            <p class="text-sm">Air King Automatic Black</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
                        </td>
                        <td>
                          <p class="text-sm">$3450</p>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="../assets/images/product/Digital_Mini_Quartz/Digital_Mini_Quartz_1.jpg"
                                alt="" />
                            </div>
                            <p class="text-sm">Digital Mini Quartz</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="../assets/images/product/Ironman_Sleek_50-Lap/Ironman_Sleek_50-Lap_1.jpg"
                                alt="" />
                            </div>
                            <p class="text-sm">Ironman Sleek 50 Lap</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="product">
                            <div class="image">
                              <img
                                src="../assets/images/product/Ray_II_Automatic_Blue_Dial/Ray_II_Automatic_Blue_Dial_1.jpg"
                                alt="" />
                            </div>
                            <p class="text-sm">Ray II</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="../assets/images/product/Promaster_Blue/Promaster_Blue_1.jpg" alt="" />
                            </div>
                            <p class="text-sm">Promaster blue</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
                      ...
                      <tr>
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="../assets/images/product/SEIKO_5/SEIKO_5_1.jpg" alt="" />
                            </div>
                            <p class="text-sm">Seiko 5</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
                      ...
                      <tr>
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="../assets/images/product/Air-King_Automatic_Black/Air-King_Automatic_Black_1.jpg" alt="" />
                            </div>
                            <p class="text-sm">Air King Automatic</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
                      ...
                      <tr>
                        <td>
                          <div class="product">
                            <div class="image">
                              <img src="../assets/images/product/Kinetic_Green_Dial_Brown_Leather/Kinetic_Green_Dial_Brown_Leather_1.jpg" alt="" />
                            </div>
                            <p class="text-sm">Kinetic Green</p>
                          </div>
                        </td>
                        <td>
                          <p class="text-sm">Watches</p>
