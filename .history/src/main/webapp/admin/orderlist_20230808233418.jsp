          ...
          <div class="main-contents">
            <div class="ordered-list">
              ...
              <div class="ordered-wrapper ">
                <div class=" orderd">
                  <span class="order-id">user id: 1</span>
                  <span class="order-id">order id: </span>
                  <span class="order-date">date: sdf</span>
                  <span class="order-total-price"> price : asdsa
                    $sfds</span>
                </div>
                  ...
                  <div class="ordered-item col">
                    <div class="ordered-item-detail row">
                      <div class="main-item-img">
                        <img src="../assets/images/product/Air-King_Automatic_Black/Air-King_Automatic_Black_1.jpg"
                          alt="">
                      </div>
                      <a href="" class="main-item-text">
                      ...
                      <span>
                        <form action="" method="post">
                          <select>
                            <option value="Đang đợi duyệt" name="orderStatus">Đang đợi duyệt</option>
                            <option value="Đang Vận chuyển" name="orderStatus">Đang vận chuyển</option>
                            <option value="Đang đợi duyệt" name="orderStatus">Đã giao</option>
                          </select>
                        </form>
                      </span>
                    </div>
