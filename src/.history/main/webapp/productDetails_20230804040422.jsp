			...
			<div id="contents" class="ptb-160">
					...
					<div class="row product-detail">
						<div class="image-main row">
							<div class="col thumb-item">
								...
								<img class="sub-img" src="./assets/images/product/" alt="">
								<script>
									document.querySelector('.sub-img').src += document.querySelector('.sub-img').src + ${product.img} + "/" + ${product.img} + "_" + ${i} + "jpg";
								</script>
					...
					<div class="dg-wrap no-wrap row">
						...
						<div class="guarantee-list col">
							...
							<div class="g-item">
								...
								<p>
									All of our items ship from the United States. <br> <a href="">View Details</a>
								</p>
							</div>
						</div>
					</div>
				...
				<c:if test="${product == null }">
					<div class="empty-result col">
						<img src="./assets/images/logo/no-rs-found.jpg" alt="" /> <span class="no-result-title">No
							result</span>
					</div>
				</c:if>
			</div>
