			...
			<div id="contents" class="ptb-160">
				<c:if test="">
					<div class="row product-detail">
						...
						<div class="product-info col1  pl-6p">
							...
							<div class="product-detail-heading">
								<strong class="product-brand p-4"> ROLEX </strong> <br> <span class="product-name p-4">
									Clifton GMT Automatic Black Dial
									Men's Watch </span> <br> <span class="product-info-no p-4">
									Item No. RB2140 902/51 50 </span> <br>
							</div>
							<div class="product-detail-price p-4">

								<span class="promo-badge">coupon</span> <span class="promo-text p-4">Giảm
									<strong>$375</strong> Khi nhập
					...
					<div class="dg-wrap no-wrap row">
							...
							<div class="more-detail js-more-details">
								...
								<div class="row">
									...
									<div class="col-3 pb-32 ">
										...
										<span class="more-value">Date, Day, Hour, Minute, Second</span> <br>
								...
								<div class="row">
									...
									<p>Silver-tone stainless steel case with a black leather
										...
										silver-tone hands and Arabic numeral hour markers. Minute markers
										around the outer rim. Dial Type: Analog. Date display at the 3
										o'clock position. One subdial displaying: second time zone. ETA
										Caliber 2893-2 Automatic movement, based upon ETA 2892-A2,
										containing 21 Jewels, bitting at 28800 vph, and has a power
										reserve of approximately 42 hours. Scratch resistant sapphire
										crystal. Pull / push crown. Transparent case back. Round case
										shape, case size: 43 mm, case thickness: 11.4 mm. Band width: 21
										mm, band length: 8 inches. Deployment with push button release
										clasp. Water resistant at 50 meters / 165 feet. Functions: date,
										GMT, second time zone, hour, minute, second. Additional Info:
										hours, minutes, seconds, date, dual time. Clifton Series. Luxury
										watch style. Watch label: Swiss Movt. Baume et Mercier Clifton
										GMT Automatic Black Dial Men's Watch M0A10302.</p>
								</div>
							</div>
							<a href="" class="show-more js-show-more-btn"> Show More </a> <a href=""
								class="show-less hide-modal js-show-less-btn"> Show
								Less </a>
						</div>
						<div class="guarantee-list col">
							...
							<div class="g-item">
								...
								<p>
									All of our items ship from the United States. <br> <a href="">View
										Details</a>
								</p>
							</div>
						</div>
					...
					<div class="review-wrapper">
						...
						<div class="review-rate">
							<span class="avg-score">4.4</span> <i class="ti-star rate-star js-rate-star"></i> <i
								class="ti-star rate-star js-rate-star"></i> <i
								class="ti-star rate-star js-rate-star"></i> <i
								class="ti-star rate-star js-rate-star"></i> <i
								class="ti-star rate-star js-rate-star"></i> <span class="reviews-label">8 Reviews</span>
						</div>
						<div class="hr"></div>
								...
								<div class="product-rating__main col1">
									...
									<div class="product-rating__comment">
										<span>Lorem, ipsum dolor sit amet consectetur adipisicing
											elit. Consequuntur architecto impedit praesentium non quae harum
											alias officiis dignissimos! Repellat fuga consectetur veritatis
											minima asperiores reprehenderit optio quia maiores nesciunt
											labore.</span>
									</div>
								</div>
							</div>
						...
						<div class="page-controller row">
							<a href=""><i class="ti-angle-left"></i> </a> <a href="">1</a> <a href="">2</a> <a
								href=""><i class="ti-angle-right"></i></a>
				...
				<c:if test="${product == null }">
					<div class="empty-result col">
						<img src="./assets/images/logo/no-rs-found.jpg" alt="" />
						<span class="no-result-title">No result</span>
					</div>
				</c:if>
			</div>
