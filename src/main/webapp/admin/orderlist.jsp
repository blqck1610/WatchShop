...
<body>
	...
	<aside class="sidebar-nav-wrapper">
		<div class="navbar-logo">
			<a href="dashboard"> <img
				src="../assets/images/logo/logostore.png" width="180" alt="logo" />
			</a>
		</div>
		<nav class="sidebar-nav">
			<ul>
				<li class="nav-item nav-item-has-children"><a href="#0"
					...
					aria-label="Toggle navigation"> <span class="icon"> <svg
                  ...
                  <path
					...
					<ul id="ddmenu_1" class="collapse show dropdown-nav">
						<li><a href="dashboard" class="active"> WatchStore </a></li>
						<li><a href="orderlist" class="active"> Order list </a></li>
					</ul></li>
				<li class="nav-item nav-item-has-children"><a href="#0"
                      ...
                      <path
								...
								<ul class="dropdown-menu dropdown-menu-end"
									...
									<li><a href="#0">
											...
											<div class="content">
												<h6>
													Nguyen <span class="text-regular"> add new order </span>
												</h6>
									...
									<li><a href="#0">
											...
											<div class="content">
												<h6>
													nguyen <span class="text-regular"> review product </span>
												</h6>
												<p>Lorem ipsum dolor sit amet, consect etur adipiscing
													elit Vivamus tortor.</p>
												<span>1 mins ago</span>
								...
								<ul class="dropdown-menu dropdown-menu-end"
									...
									<li>
										<div class="author-info flex items-center !p-1">
											<div class="image">
												<img src="../assets/images/logo/avatar_default.jpg"
													alt="image">
											</div>
											<div class="content">
					...
					<div class="ordered-list">
						...
						<div class="ordered-wrapper ">
							...
							<c:forEach items="${orders }" var="order">
								<div class=" orderd">
									<span class="order-id">user id: ${order.userID }</span> <span
										class="order-id">order id: ${order.id } </span> <span
										class="order-date">date: ${order.date }</span> <span
										class="order-total-price"> total price:
										${order.totalMoney }</span>
								</div>
								...
								<c:forEach items="${order.orderDetails }" var="item">
									<div class="ordered-detail ">
										<div class="ordered-item ">
											...
											<a href="" class="main-item-text"> <span>${item.product.brand
											...
											<span>
												<form action="orderedit" method="post">
													...
													<input type="text" name="idProduct" value="${item.product.idProduct }" hidden = true>
													<select name ="status" onchange="this.form.submit()">
													
														<option ${(item.status eq "Đang vận chuyển" || item.status eq "Đã giao" )? "disabled" : ""   } value="Đang đợi duyệt" name="orderStatus">Đang
															đợi duyệt</option>
														<option ${( item.status eq "Đã giao" )? "disabled" : ""   } value="Đang vận chuyển" name="orderStatus">Đang
															vận chuyển</option>
														<option value="Đã giao" name="orderStatus">Đã
															giao</option>
													</select>
												</form>
											</span>
	...
	<script src="assets/js/opendetail.js"></script>
	<script>
